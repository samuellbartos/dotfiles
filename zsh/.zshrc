# HISTORY
unset HISTFILE # turn off history until proper directory is configured in zsh/exports
...
# MODULES
[[ -s "$XDG_CONFIG_HOME/zsh/path" ]] && source "$XDG_CONFIG_HOME/zsh/path"
[[ -s "$XDG_CONFIG_HOME/zsh/aliases" ]] && source "$XDG_CONFIG_HOME/zsh/aliases"
[[ -s "$XDG_CONFIG_HOME/zsh/functions" ]] && source "$XDG_CONFIG_HOME/zsh/functions"
[[ -s "$XDG_CONFIG_HOME/zsh/prompt" ]] && source "$XDG_CONFIG_HOME/zsh/prompt"
[[ -s "$XDG_CONFIG_HOME/zsh/exports" ]] && source "$XDG_CONFIG_HOME/zsh/exports"
[[ -s "$XDG_CONFIG_HOME/zsh/extras" ]] && source "$XDG_CONFIG_HOME/zsh/extras"
