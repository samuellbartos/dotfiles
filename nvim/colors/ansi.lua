...
vim.api.nvim_set_hl(0, "StatusLine", {ctermfg=colors["b_black"], ctermbg=colors["b_black"]})
...
vim.api.nvim_set_hl(0, "diffAdded", {ctermfg=colors["b_green"]})
vim.api.nvim_set_hl(0, "diffRemoved", {ctermfg=colors["b_red"]})
vim.api.nvim_set_hl(0, "diffChanged", {ctermfg=colors["b_blue"]})
vim.api.nvim_set_hl(0, "diffOldFile", {ctermfg=colors["b_yellow"]})
vim.api.nvim_set_hl(0, "diffNewFile", {ctermfg=colors["b_magenta"]})
vim.api.nvim_set_hl(0, "diffFile", {ctermfg=colors["b_blue"]})
vim.api.nvim_set_hl(0, "diffLine", {ctermfg=colors["white"]})
vim.api.nvim_set_hl(0, "diffIndexLine", {ctermfg=colors["b_cyan"]})
